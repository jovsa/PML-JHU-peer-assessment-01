...
<center> <h1>Predicting Exercises Quality from Accelerometer Data with Machine Learning</h1> </center>
...
*Conlusion*: The great a amount of correlation among variables suggest that techniques such as PCA can be used to characterize the magnitude of the problem. PCA would also help reduce computation complexity and increase numerical stability.
